...
import com.speedata.uhf.dialog.MaskDialog;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private void initUI() {
        ...
        mask = (Button) findViewById(R.id.btn_mask);
    ...
    public void onClick(View arg0) {
        ...
        if (arg0 == Read_Tag) {
            ...
            //掩码
            MaskDialog maskDialog = new MaskDialog(this, iuhfService, current_tag_epc);
            maskDialog.setTitle(R.string.Mask_Btn_T);
            maskDialog.show();
        }
    }
